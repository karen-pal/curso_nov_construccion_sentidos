...
//const translate2 = require('translator-promise');
...
const clock = async function (ctx, w, h) {
  ...
  let data = await loadImage("escher.jpeg", w, h)
  let word;
  for ( i = 0; i< data.bitmap.width; i++) {
      ...
      //const result = await translate2(word,'auto');
      if ( i%300 === 0 && i!==0) {
          console.log("hola ",i);
