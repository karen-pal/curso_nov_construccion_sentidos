...
function id(x) { return x[0]; }
 ...
 function DESATURAR ([d1,,d2]) { 
    ...
    {"name": "Hue", "symbols": ["AZUL"]},
    {"name": "FUERTE$subexpression$1", "symbols": ["Luz"]},
    {"name": "FUERTE$subexpression$1", "symbols": ["Hue"]},
    ...
    {"name": "FUERTE", "symbols": ["FUERTE$subexpression$1", "_", "FUERTE$string$1"], "postprocess": SATURAR},
    {"name": "APAGADO$subexpression$1", "symbols": ["Luz"]},
    {"name": "APAGADO$subexpression$1", "symbols": ["Hue"]},
    ...
    {"name": "APAGADO", "symbols": ["APAGADO$subexpression$1", "_", "APAGADO$string$1"], "postprocess": DESATURAR},
